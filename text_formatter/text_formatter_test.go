...
func TestDisableLevelTruncation(t *testing.T) {
	...
	checkDisableTruncation := func(disabled bool, level log.Level) {
	...
	checkDisableTruncation(true, log.DebugLevel)
	checkDisableTruncation(true, log.InfoLevel)
	checkDisableTruncation(false, log.ErrorLevel)
	checkDisableTruncation(false, log.InfoLevel)
}

func TestDisableTimestampWithColoredOutput(t *testing.T) {
	tf := &TextFormatter{DisableTimestamp: true, ForceColors: true}

	b, _ := tf.Format(log.WithField("test", "test"))
